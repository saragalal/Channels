...
internal enum Asset {
  internal enum Assets {
    internal static let appName = ImageAsset(name: "appName")
    internal static let blueCircle = ImageAsset(name: "blueCircle")
    internal static let darkGreenCircle = ImageAsset(name: "darkGreenCircle")
  ...
  internal enum Colors {
    internal static let categoryBackground = ColorAsset(name: "CategoryBackground")
    ...
    internal static let titleChannelsColor = ColorAsset(name: "TitleChannelsColor")
    internal static let whiteColor = ColorAsset(name: "White Color")
  }
}
